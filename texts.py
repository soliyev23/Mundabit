...
BOT = {
    "uz": {
        ...
        "en_game_done": "🎮 O'yin tugadi",
        "en_game_score": "{total} tadan {ok} ta to'g'ri",
        "en_game_relearn": "Yodlashga qo'shildi:",
        "en_game_empty": "🎮 O'yin uchun hali so'z yo'q. Avval «📚 Vocabulary»dan so'z o'rganing.",
        "en_try_sentence": "✍️ Xohlasangiz, bugungi so'zlar bilan gap tuzib ko'ring — "
                           "inglizcha yozib yuboring, tekshirib beraman.",
        "en_sentence_ok": "✅ To'g'ri!",
        "en_sentence_fix": "❌ Xato bor. To'g'ri varianti:\n<b>{corrected}</b>",
        "en_sentence_note": "💡 {note}",
        "en_sentence_not_en": "✍️ Gapni ingliz tilida yozing.",
        "en_sentence_long": "✍️ Gap juda uzun — {n} belgigacha yozing.",
        "en_sentence_limit": "✍️ Bugungi tekshiruvlar tugadi — ertaga davom etamiz.",
        "en_sentence_error": "⚠️ Hozir tekshira olmadim. Birozdan keyin qayta yuboring.",
    ...
    "ru": {
        ...
        "en_game_done": "🎮 Игра окончена",
        "en_game_score": "Верно {ok} из {total}",
        "en_game_relearn": "Снова на изучение:",
        "en_game_empty": "🎮 Для игры пока нет слов. Сначала изучите слова в «📚 Vocabulary».",
        "en_try_sentence": "✍️ Если хотите, составьте предложение со словами на сегодня — "
                           "напишите его по-английски, я проверю.",
        "en_sentence_ok": "✅ Верно!",
        "en_sentence_fix": "❌ Есть ошибка. Правильно:\n<b>{corrected}</b>",
        "en_sentence_note": "💡 {note}",
        "en_sentence_not_en": "✍️ Напишите предложение по-английски.",
        "en_sentence_long": "✍️ Слишком длинно — не больше {n} символов.",
        "en_sentence_limit": "✍️ Проверки на сегодня закончились — продолжим завтра.",
        "en_sentence_error": "⚠️ Сейчас не получилось проверить. Попробуйте чуть позже.",
        "en_title": "🇬🇧 <b>English</b>",
